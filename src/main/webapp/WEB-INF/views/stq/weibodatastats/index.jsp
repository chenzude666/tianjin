...
<body>
	<div>
		...
		<div>
			...
			<form id="queryForm" class="well form-inline" method="get" action="${ctx}/manage/stq/weibodatastats/index">
		...
		<table class="table table-striped table-bordered table-condensed">
			...
			<tbody>
				<c:forEach items="${weiboStatss.content}" var="item" varStatus="s">
		...
		<tags:pagination page="${weiboStatss}" paginationSize="5" />
