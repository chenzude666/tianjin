 ...
 * 
 */
public class ESRestClientHelper {
	
	private static ESRestClientHelper instance;
	
	private static final String ES_IP = PropertiesUtil.prop("ES_IP");
	
	private static final Integer ES_PORT = Integer.valueOf(PropertiesUtil.prop("ES_PORT"));
	...
	public static synchronized ESRestClientHelper getInstance() {
		if (instance == null) {
			instance = new ESRestClientHelper();
		}
		return instance;
	}

	private ESRestClientHelper() {
		init();
	}
		...
		restClient = RestClient.builder(new HttpHost(ES_IP, ES_PORT))
		        .setRequestConfigCallback(new RestClientBuilder.RequestConfigCallback() {
		            ...
		            public RequestConfig.Builder customizeRequestConfig(RequestConfig.Builder requestConfigBuilder) {
		                return requestConfigBuilder.setSocketTimeout(100 * 60 * 1000).setConnectTimeout(100 * 60 * 1000);
		            }
		        })
